...
class Setting_power: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    var _settings:NSArray=[["title":"所有人可见","des":""],["title":"仅自己可见","des":""],["title":"所有朋友可见","des":""],["title":"选中朋友可见","des":""],["title":"选中朋友不可见","des":""]]
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font = Config._font_cell_title_normal
    ...
    //----设置位置
    func refreshView(){
        _tableView?.frame = CGRect(x: 0, y: 62+_gap, width: self.view.frame.width, height: 5*_tableCellH-1)
    }
