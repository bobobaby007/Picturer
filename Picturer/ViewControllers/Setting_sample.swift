...
class Setting_sample: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    func setup(){
        ...
        _btn_cancel=UIButton(frame:CGRect(x: 5, y: 5, width: 40, height: Config._barH))
        ...
        _btn_save=UIButton(frame:CGRect(x: self.view.frame.width-50, y: 5, width: 40, height: Config._barH))
        ...
        _title_label=UILabel(frame:CGRect(x: 50, y: 5, width: self.view.frame.width-100, height: Config._barH))
