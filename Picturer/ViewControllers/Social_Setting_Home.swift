...
class Social_Setting_Home: UIViewController,ContentEditer_delegate{
    let _gap:CGFloat=15
    ...
    let _setion_1_titles:NSArray = ["Picturer帐号","修改密码","推送设置","更换背景图片","关于Picturer","清空缓存","退出登录"]
    ...
    func _btnHander(__sender:UIButton){
        ...
        case 0://---
            ...
            break
        case 1://---
            let _cont:Social_Setting_passw = Social_Setting_passw()
            self.navigationController?.pushViewController(_cont, animated: true)
            break
        case 2://---
            let _cont:Social_Setting_push = Social_Setting_push()
            self.navigationController?.pushViewController(_cont, animated: true)
            break
        case 3://---
            let _cont:Social_Setting_bg = Social_Setting_bg()
            self.navigationController?.pushViewController(_cont, animated: true)
            break
        case 4://---
            let _cont:Social_Setting_about = Social_Setting_about()
            self.navigationController?.pushViewController(_cont, animated: true)
            break
        case 5://----
