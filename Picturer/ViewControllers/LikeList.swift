...
class LikeList: UIViewController, UITableViewDelegate,UITableViewDataSource,Inputer_delegate,CommentList_Cell_delegate,LikeList_Cell_delegate{
    ...
    func setup(){
        ...
        _tableView?.registerClass(LikeList_Cell.self, forCellReuseIdentifier: "LikeList_Cell")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell:LikeList_Cell = _tableView!.dequeueReusableCellWithIdentifier("LikeList_Cell", forIndexPath: indexPath) as! LikeList_Cell
    ...
    func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        ...
        // var cell:LikeList_Cell = _tableView!.dequeueReusableCellWithIdentifier("LikeList_Cell", forIndexPath: indexPath) as! LikeList_Cell
        
        
        let cell:LikeList_Cell = _tableView!.dequeueReusableCellWithIdentifier("LikeList_Cell") as! LikeList_Cell
        cell.setUp(self.view.frame.width)
        cell._setComment(_dataArray!.objectAtIndex(_dataArray!.count - 1 - indexPath.row) as! NSDictionary)
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let cell:LikeList_Cell = _tableView!.cellForRowAtIndexPath(indexPath) as! LikeList_Cell
        cell.selected = false
